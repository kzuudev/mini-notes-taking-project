...
<main>
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        ...
        <p class="mb-6">
            <a href="/notes-mini/notes" class="text-blue-500 underline">Go back...</a>
        </p>

        <p><?= htmlspecialchars($note['body']) ?></p>

        <form action="/note/destroy" class="mt-6" method="POST" >
            <input type="hidden" name="_method" value="DELETE">
            <input class="hidden" name="id" type="text" value="<?= $note['id'] ?>">
